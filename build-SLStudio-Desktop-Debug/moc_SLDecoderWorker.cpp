...
void SLDecoderWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::imshow)) {
                *result = 0;
            }
        }
        {
            typedef void (SLDecoderWorker::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::showShading)) {
                *result = 1;
            }
        }
        {
            typedef void (SLDecoderWorker::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::showDecoderUp)) {
                *result = 2;
            }
        }
        {
            typedef void (SLDecoderWorker::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::showDecoderVp)) {
                *result = 3;
            }
        }
        {
            typedef void (SLDecoderWorker::*_t)(cv::Mat , cv::Mat , cv::Mat , cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::newUpVp)) {
                *result = 4;
            }
        }
        {
            typedef void (SLDecoderWorker::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLDecoderWorker::error)) {
                *result = 5;
            }
        }
    }
...
const QMetaObject SLDecoderWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SLDecoderWorker.data,
      qt_meta_data_SLDecoderWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
