...
public:
    ...
    {
        SLTrackerDialog->setWindowTitle(QApplication::translate("SLTrackerDialog", "Tracker", 0));
        actionStart_Tracking->setText(QApplication::translate("SLTrackerDialog", "Start Tracking", 0));
        tabWidget->setTabText(tabWidget->indexOf(poseTab), QApplication::translate("SLTrackerDialog", "Pose", 0));
        translationTraceWidget->setText(QString());
        rotationTraceWidget->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(traceTab), QApplication::translate("SLTrackerDialog", "Trace", 0));
        startStopPushButton->setText(QApplication::translate("SLTrackerDialog", "Start Tracking", 0));
    } // retranslateUi
