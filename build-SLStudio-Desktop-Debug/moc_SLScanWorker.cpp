...
void SLScanWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLScanWorker::showHistogram)) {
                *result = 0;
            }
        }
        {
            typedef void (SLScanWorker::*_t)(cv::Mat );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLScanWorker::newFrame)) {
                *result = 1;
            }
        }
        {
            typedef void (SLScanWorker::*_t)(std::vector<cv::Mat> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLScanWorker::newFrameSeq)) {
                *result = 2;
            }
        }
        {
            typedef void (SLScanWorker::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLScanWorker::error)) {
                *result = 3;
            }
        }
        {
            typedef void (SLScanWorker::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SLScanWorker::finished)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject SLScanWorker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SLScanWorker.data,
      qt_meta_data_SLScanWorker,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
