...
public:
    ...
    {
        SLCalibrationDialog->setWindowTitle(QApplication::translate("SLCalibrationDialog", "SL Calibration", 0));
        snapButton->setText(QApplication::translate("SLCalibrationDialog", "Snap", 0));
        calibrateButton->setText(QApplication::translate("SLCalibrationDialog", "Calibrate", 0));
        label->setText(QApplication::translate("SLCalibrationDialog", "Size (mm):", 0));
        label_3->setText(QApplication::translate("SLCalibrationDialog", "Rows:", 0));
        label_4->setText(QApplication::translate("SLCalibrationDialog", "Cols:", 0));
        cancelButton->setText(QApplication::translate("SLCalibrationDialog", "&Cancel", 0));
        saveButton->setText(QApplication::translate("SLCalibrationDialog", "&Save", 0));
    } // retranslateUi
